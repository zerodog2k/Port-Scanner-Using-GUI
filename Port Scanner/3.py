...
root.configure(bg="#d0e7ff")  # Light blue background color

default_start, default_end, default_first_port, default_last_port = load_user_input()

start_label = ttk.Label(root, text="Enter Start IP:", background="#d0e7ff")
start_label.pack(pady=10)

start_entry = ttk.Entry(root, style="TEntry", font=("Times New Roman", 12))
start_entry.insert(0, default_start)
start_entry.pack(pady=10)

end_label = ttk.Label(root, text="Enter End IP:", background="#d0e7ff")
end_label.pack(pady=10)

end_entry = ttk.Entry(root, style="TEntry", font=("Times New Roman", 12))
...
style = ttk.Style()
style.configure("TButton", foreground="black", background="#6699ff", font=("Times New Roman", 14, "bold"))  # Blue button

result_listbox = tk.Listbox(root, height=10, width=70, font=("Times New Roman", 12), selectbackground="#cce0ff")
